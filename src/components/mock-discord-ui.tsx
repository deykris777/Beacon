...
export const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[400px] sm:min-h-[600px] lg:min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      {/* server list */}
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className='px-2 mb-4'>
            ...
            <div className='flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer'>
              ...
              />
              <span className='font-medium'>Procmon</span>
            </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">Procmon</p>
          </div>
