...
const socialLinks = [
  { name: 'Twitter', icon: Twitter, href: 'https://x.com/bixl_007' },
  { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/bishal-baira/' },
  { name: 'GitHub', icon: Github, href: 'https://github.com/bixl007' },
]
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div className="lg:w-1/3">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-brand-600">Procmon</span>
            </Link>
